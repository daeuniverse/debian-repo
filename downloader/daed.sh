...
unzip "$daed_temp_dir/daed_amd64_${daed_remote_version}.zip" daed-linux-x86_64 -d ./ && mv ./daed-linux-x86_64 ./daed_amd64_${daed_remote_version} && chmod +x ./daed_amd64_${daed_remote_version}
unzip "$daed_temp_dir/daed_arm64_${daed_remote_version}.zip" daed-linux-arm64 -d ./ && mv ./daed-linux-arm64 ./daed_arm64_${daed_remote_version} && chmod +x ./daed_arm64_${daed_remote_version}
unzip "$daed_temp_dir/daed_i386_${daed_remote_version}.zip" daed-linux-x86_32 -d ./ && mv ./daed-linux-x86_32 ./daed_i386_${daed_remote_version} && chmod +x ./daed_i386_${daed_remote_version}
unzip "$daed_temp_dir/daed_riscv64_${daed_remote_version}.zip" daed-linux-riscv64 -d ./ && mv ./daed-linux-riscv64 ./daed_riscv64_${daed_remote_version} && chmod +x ./daed_riscv64_${daed_remote_version}
rm -rf "$daed_temp_dir"
