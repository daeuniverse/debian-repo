...
```shell [Retry polluted responses]
...
Source: [dae upstream](https://github.com/daeuniverse/dae/blob/5db27a0028d36e7847bd3796497df952337a20e2/docs/en/configuration/dns.md) · [AGPL-3.0 license](/upstream/dae-LICENSE.txt).
